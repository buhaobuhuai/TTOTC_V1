...
<template>
	<div class="site-content" style="margin-top: 60px;">
		<div class="tzjyqy" style="margin: 0 25px; background:#ffffff">
			<div class="cion-cont">
				...
				<el-row justify="space-between">
					<el-col :span="10" :xs="24">
						...
						<div class="cion-ts">
							<span class="cion-ed right">余额：{{money}}</span>
						</div>
					</el-col>
					<el-col :span="4" :xs="24">
					...
					<el-col :span="10" :xs="24">
						...
						<div class="cion-ts"><span class="cion-ed right">余额：{{money1}}</span></div>
					</el-col>
				</el-row>
				</el-row>
				<div class="cion-title"></div>
		
				<el-row justify="space-between" class="cion-rate">
					<el-col :span="6" :xs="12">
						<div class="cion-rate">
							<div>预期获得</div>
							<div>1591.1 USDC</div>
						...
						<div class="cion-rate flex">
							<div class="">
								<div style="position: relative;">
									...
									<img style="position: absolute;left: -10px !important;" sizeraw="20" class="cion-logo"
										alt="WETH logo"
