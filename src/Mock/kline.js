	...
	response: () => {
		...
		for (let i = 0; i < 100; i++) {
			let newArticleObject = {
				id: i,
				close: Random.natural(2800, 2888),
				high: Random.natural(800, 2888),
				low: Random.natural(200, 2888),
				ma5: Random.natural(2800, 2888),
				ma10: Random.natural(2800, 2888),
				ma20: Random.natural(2800, 2888),
				ma30: Random.natural(2800, 2888),
				open: Random.natural(2800, 2888),
				price: Random.natural(800, 28888),
				price_equal: Random.natural(1000, 2000),
				time: Random.date(),
				volume: Random.natural(10000, 20000),
				yesterday_close: Random.natural(2800, 2888),
...
// Mock.mock('/kline/minute_k', 'post', getMinute_k); // kline模拟数据
// Mock.mock('/kline/market', 'post', getMarket); //home默认数据
// Mock.mock('/kline/day_k', 'get', getDay_k); //home日k
// Mock.mock('/kline/week_k', 'get', getWeek_k); //home周k
// Mock.mock('/kline/month_k', 'get', getMonth_k); //home月k
